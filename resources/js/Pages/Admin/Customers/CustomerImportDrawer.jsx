...
export default function CustomerImportDrawer({ open, onClose, result = null }) {
    ...
    const submit = (e) => {
        ...
        form.post(route('admin.import-export.customers.import'), {
            forceFormData: true,
            preserveScroll: true,
    ...
    return (
        <Drawer
            ...
            description="Upload CSV or Excel. Columns: name, code, phone, email, address, opening_balance, is_active."
            width="half"
        >
            <div className="flex h-full flex-col gap-5">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <a
                            href={route('admin.import-export.customers.sample', { format: 'xlsx' })}
                            className="rounded-lg border border-theme-border px-3 py-2 text-sm font-medium text-theme-ink hover:bg-theme-bg"
                        >
                            Excel sample
                        </a>
                        <a
                            href={route('admin.import-export.customers.sample', { format: 'csv' })}
                            className="rounded-lg border border-theme-border px-3 py-2 text-sm font-medium text-theme-ink hover:bg-theme-bg"
                        >
                            CSV sample
                        </a>
