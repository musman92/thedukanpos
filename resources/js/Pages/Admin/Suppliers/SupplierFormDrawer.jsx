...
export default function SupplierFormDrawer({ open, supplier = null, onClose }) {
    ...
    const submit = (e) => {
        ...
        if (editing) {
            form.post(route('admin.suppliers.update', supplier.id), options);
            return;
        }
            ...
            <form onSubmit={submit} className="flex h-full flex-col">
                <div className="space-y-4">
                    ...
                    <Field
                        ...
                        hint="Optional. Blank assigns S01, S02…"
                    >
                        <Input
