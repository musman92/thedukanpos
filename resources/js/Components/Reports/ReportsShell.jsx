    ...
    return (
        <AdminLayout title={branch?.name ? `Reports · ${branch.name}` : 'Reports'}>
            ...
            <div className="dp-card overflow-visible print:border-0 print:shadow-none">
                <div className="flex flex-wrap items-start justify-between gap-3 border-b border-theme-border px-5 py-4 print:border-0">
                    <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 print:hidden">
                        <button
                            type="button"
                            onClick={onPrint}
                            className="inline-flex items-center gap-1.5 rounded-lg border border-theme-border bg-theme-surface px-3 py-2 text-xs font-semibold text-theme-ink-soft transition hover:border-theme-primary/40 hover:text-theme-ink"
                        >
                ...
                <div className="flex flex-wrap gap-2 border-b border-theme-border px-5 py-4 print:hidden">
                ...
                {showFilters && (
                    filterBar ? (
                        <div className="border-b border-theme-border bg-theme-bg/50 px-5 py-3.5 print:hidden">
                            {filterBar}
                        </div>
                    ) : (
                    <form
                        onSubmit={apply}
                        className="flex flex-wrap items-end gap-3 border-b border-theme-border bg-theme-bg/50 px-5 py-3.5 print:hidden"
                    >
